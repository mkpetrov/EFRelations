...
{
    public partial class FootballBettingDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeTeamGoals = table.Column<short>(nullable: false),
                    AwayTeamGoals = table.Column<short>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SquadNumber = table.Column<short>(nullable: false),
                    TeamId = table.Column<int>(nullable: false),
                    PositionId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameId = table.Column<int>(nullable: false),
                    PlayerId = table.Column<int>(nullable: false),
                    ScoredGoals = table.Column<short>(nullable: false),
                    Assists = table.Column<short>(nullable: false),
                    MinutesPlayed = table.Column<short>(nullable: false)
                },
                constraints: table =>
                {
